...
**字段说明与限制（必须高度抽象，严禁记录聊天流水账或具体消息事实）：**
- 群聊主题：概括群聊的定位与核心话题（30 字以内）。
  * 正例：“AI技术探讨与科技产品交流”
  * 反例：“群友今天讨论了ChatGPT的新模型和Claude的收费”
- 氛围特征：群内交流氛围与活跃规律（30 字以内）。
  * 正例：“高频互动，热衷斗图，成员说话较为打趣直接”
  * 反例：“小明在下午3点发了很多搞笑表情包”
- 核心规则与忌讳：群内明确的规定或潜在的敏感讨论点/忌讳（30 字以内）。
  * 正例：“严禁政治话题，不喜刷屏广告”
  * 反例：“群主刚才警告了乱发链接的小刚”
